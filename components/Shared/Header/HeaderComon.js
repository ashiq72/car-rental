...
export default function HeaderComon() {
  ...
  return (
    <div
      className={`w-full flex justify-center z-40 fixed top-0 transition-transform duration-300 px-4 mx-auto text-white shadow-lg ${show} bg-black/75
       `}
    >
      <div
